...
use App\Nightwatch\Api\NightwatchOutgoingRequestScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchOutgoingRequestController extends Controller
{
    public function __construct(
        private readonly NightwatchOutgoingRequestScreenService $service,
    ) {
        //
    }
