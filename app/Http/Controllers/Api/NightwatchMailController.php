...
use App\Nightwatch\Api\NightwatchMailScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchMailController extends Controller
{
    public function __construct(
        private readonly NightwatchMailScreenService $service,
    ) {
        //
    }
