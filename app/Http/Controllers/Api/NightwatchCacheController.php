...
use App\Nightwatch\Api\NightwatchCacheScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchCacheController extends Controller
{
    public function __construct(
        private readonly NightwatchCacheScreenService $service,
    ) {
        //
    }
