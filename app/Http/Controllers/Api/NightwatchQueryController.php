...
use App\Nightwatch\Api\NightwatchQueryScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchQueryController extends Controller
{
    public function __construct(
        private readonly NightwatchQueryScreenService $service,
    ) {
        //
    }
