...
use App\Nightwatch\Api\NightwatchExceptionScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchExceptionController extends Controller
{
    public function __construct(
        private readonly NightwatchExceptionScreenService $service,
    ) {
        //
    }
