...
use App\Nightwatch\Api\NightwatchScheduledTaskScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchScheduledTaskController extends Controller
{
    public function __construct(
        private readonly NightwatchScheduledTaskScreenService $service,
    ) {
        //
    }
