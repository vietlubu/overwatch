...
use App\Nightwatch\Api\NightwatchNotificationScreenService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

final class NightwatchNotificationController extends Controller
{
    public function __construct(
        private readonly NightwatchNotificationScreenService $service,
    ) {
        //
    }
